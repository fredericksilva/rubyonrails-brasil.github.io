...
config[:casper] = {
  blog: {
    url: 'http://rubyonrails-brasi.github.io',
...
app.data.authors.collect {|author| author.keys.first }.each do |author_slug|
  proxy "/author/#{author_slug}.html",
        '/author.html',
        locals: { 'page_type' => 'author', current_author: author_slug },
        ignore: true
end
